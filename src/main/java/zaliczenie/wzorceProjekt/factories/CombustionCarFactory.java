...
public  class CombustionCarFactory  {
    ...
    public static CombustionCar CreateCar(int id, String brand, String model, Date production_date, String color, String photo_url, IFuelType fuel_type, CarEquipment carEquipment, String fuelTankCapacity) {
            CombustionCar combustionCar = new CombustionCar(id, brand, model, production_date, color, photo_url, fuel_type, carEquipment, fuelTankCapacity);
